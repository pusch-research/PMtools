% REPMAX blockwise repeat minimum values
%   
...
%   Then, the minimum value is determined for each block in dimension DIM 
...
%
%   Example: A=[1 2;3 4;5 6]; B=repmin(A,1,[1 2])
%            B=
%              1     2
%              5     6
%              5     6
...
%
function B=repmin(A,dim,varargin)
