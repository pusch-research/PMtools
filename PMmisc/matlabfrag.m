...
%    'epsclean'    | cellarray of param-value options for epsclean.m (if empty epsclean is not executed)
%
...
p.addParamValue('epsclean',[],@iscell); 
...
if strcmpi(renderer,'painters')
  ...
  if ~isempty(p.Results.epsclean)
     epsclean( [FileName,'.eps'],p.Results.epsclean{:});
