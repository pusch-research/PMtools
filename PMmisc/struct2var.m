function assigns=struct2var(varargin)
%STRUCT2VAR - print a set of assignment commands that, if executed, would 
...
%
% (1) struct2var(myStruct)   %assign fields to variables
% 
%         ans =
% 
%         a = myStruct.a;     
...
%         d = myStruct.d;     
% 
% (2) struct2var(3,myStruct)   %split the last result across 3 columns
% 
%         ans =
% 
...
%         b = myStruct.b;                                             
% 
% (3) struct2var(3,myStruct,0)  %assign variables to fields 
% 
%         ans =
% 
...
%by packing them in a structure. The commands produced by struct2var(...)
...
%SYNTAX I:
%
%     assigns=struct2var(InputStructure,RHS)
% 
%     in:
