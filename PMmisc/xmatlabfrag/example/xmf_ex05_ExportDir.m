%Demonstrates how a different export directory can be used
ccc
...
% Export options
xmf_init('output', 'eps_tex', 'fixline', 1);
...
xmf_export(['tmp\subdir\' mfilename])

%% Convert afterwards
close all
xmf_export(['tmp\subdir\' mfilename], 'source', ['' mfilename], 'output', 'pdf')
