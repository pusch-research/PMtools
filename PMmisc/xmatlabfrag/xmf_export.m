...
% REVISIONS:    2011-05-16 Method added (knob_an)
%               2011-05-31 Added automatic ensuremath (kloe_ad)
%               2011-07-07 Automatic ensuremath moved to xmf_prepare (knob_an)
%               2011-08-11 Export to directories is now possible (knob_an)
%               2012-02-29 Added support for UNC paths (kloe_ad)
%
% Contact       Andreas Knoblach,  Andreas.Knoblach@dlr.de
% Copyright (C) 2011 DLR Robotics and Mechatronics              __/|__
%                                                              /_/_/_/
%                                                                |/ DLR
